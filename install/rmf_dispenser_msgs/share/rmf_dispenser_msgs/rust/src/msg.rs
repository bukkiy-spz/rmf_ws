...
impl Default for DispenserRequestItem {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DispenserRequestItem::default())
  }
}

impl rosidl_runtime_rs::Message for DispenserRequestItem {
  type RmwMsg = super::msg::rmw::DispenserRequestItem;
...
pub struct DispenserRequest {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub items: Vec<super::msg::DispenserRequestItem>,
...
impl Default for DispenserRequest {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DispenserRequest::default())
  }
}

impl rosidl_runtime_rs::Message for DispenserRequest {
  type RmwMsg = super::msg::rmw::DispenserRequest;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        items: msg.items
          .into_iter()
          .map(|elem| super::msg::DispenserRequestItem::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        items: msg.items
          .iter()
          .map(|elem| super::msg::DispenserRequestItem::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      items: msg.items
          .into_iter()
          .map(super::msg::DispenserRequestItem::from_rmw_message)
          .collect(),
    }
  }
}
...
impl Default for DispenserResult {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DispenserResult::default())
  }
}

impl rosidl_runtime_rs::Message for DispenserResult {
  type RmwMsg = super::msg::rmw::DispenserResult;
...
impl Default for DispenserState {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(super::msg::rmw::DispenserState::default())
  }
}

impl rosidl_runtime_rs::Message for DispenserState {
  type RmwMsg = super::msg::rmw::DispenserState;
