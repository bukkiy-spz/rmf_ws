...
class Metaclass_IngestorState(type):
    """Metaclass of message 'IngestorState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ingestor_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ingestor_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ingestor_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ingestor_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ingestor_state
    ...
    def IDLE(self):
        ...
        return Metaclass_IngestorState.__constants['IDLE']

    @property
    def BUSY(self):
        """Message constant 'BUSY'."""
        return Metaclass_IngestorState.__constants['BUSY']

    @property
    def OFFLINE(self):
        """Message constant 'OFFLINE'."""
        return Metaclass_IngestorState.__constants['OFFLINE']


class IngestorState(metaclass=Metaclass_IngestorState):
    """
    Message class 'IngestorState'.
