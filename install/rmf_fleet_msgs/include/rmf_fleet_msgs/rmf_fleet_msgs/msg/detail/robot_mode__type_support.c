...
static rosidl_typesupport_introspection_c__MessageMember rmf_fleet_msgs__msg__RobotMode__rosidl_typesupport_introspection_c__RobotMode_message_member_array[2] = {
  {
    "mode",  // name
